...
function Header() {
  ...
  const iconsListTwo = [{ icon: "chat" }, { icon: "notifications" }];
          ...
          <div className="h-full max-w-7xl mx-auto">
            <div className="h-full flex justify-between items-center">
              ...
              <div className="flex gap-6 items-center">
                ...
                <Button prefixIcon={"campaign"} size="default" type="primary">
                  Host
                </Button>
                <Button type="secondary" size="default" onClick={gotoLogin}>
                  Login
                </Button>
                {iconsListTwo.map((item) => (
                  ...
                  >
                    <Icon size="large" fill className="text-primary">
                      {item.icon}
                    </Icon>
                  </a>
                ))}
                <a href="" className="flex items-center justify-center">
                  <Icon size="large" className="text-primary" fill>
                    apps
                  </Icon>
                </a>
              </div>
